...
class GooglePlaceAPI {
  ...
  Future<String> getPlaceDetails(String placeId) async {
    String _url =
        "https://maps.googleapis.com/maps/api/place/details/json?place_id=$placeId&key=${DefaultFirebaseOptions.android.apiKey}";
        ...
        [
          {
            ...
            "text": "Called regarding paid advertising google pages to the top of its site of a scam furniture website misleading and taking peoples money without ever sending a product - explained the situation,  explained I'd spoken to an ombudsman regarding it.  Listed ticket numbers etc.They left the advertisement running.",
            "time": 1652286798
          },
          {
          ...
          },
          {
            ...
            "text": "I have literally never been here in my life, I am 17 and they are taking money I don't have for no reason.This is not ok. I have rent to pay and my own expenses to deal with and now this.",
            "time": 1641389490
          },
          {
...
const String samplePlaceResponse = """
{
  "html_attributions": [],
  "result":
    {
